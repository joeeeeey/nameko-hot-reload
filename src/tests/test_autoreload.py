...
from nameko_hot_reload import autoreload
...
@patch('nameko_hot_reload.autoreload._reloader')
...
@patch('nameko_hot_reload.autoreload.os')
@patch('nameko_hot_reload.autoreload.sys')
class TestReloader:

    @patch('nameko_hot_reload.autoreload._restart_application_with_autoreload')
    ...
    @patch('nameko_hot_reload.autoreload._monitor_needs_reloading')
...
class TestCodeHasChanged:
    ...
    @patch('nameko_hot_reload.autoreload.os')
    @patch('nameko_hot_reload.autoreload._generate_known_filenames')
...
class TestMonitorNeedsReloading:
    ...
    @patch('nameko_hot_reload.autoreload._ensure_echo_on')
    @patch('nameko_hot_reload.autoreload._code_has_changed')
